...
class MatmCommissionSettlement implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        try {
                ...
                $transaction = MatmTransaction::groupBy('id')
                ->where(['user_id' => $this->userId, 'is_commission_credited' => '0', 'status' => 'processed'])
                ->where('commission', '>', 0)
                ...
                if (isset($transaction) && count($transaction)) {
                    ...
                    $txnRefId = CommonHelper::getRandomString('MACOM', false);
                   ...
                   // $gstAmount = ($tdsAmount * $gst) / 100 ;
                    ...
                    DB::select("CALL matmCommissionCreditTransaction($this->userId,  'srv_1680249103', '".$txn."', '".$txnRefId."', 'matm_commission_credit', $totalAmount ,$finalAmount, $tdsAmount ,$gstAmount , '$idOfAepsTransaction', @json)");
                    ...
                    Storage::disk('local')->put($fileName, "CALL matmCommissionCreditTransaction($this->userId,  'srv_1680249103', '".$txn."', '".$txnRefId."', 'matm_commission_credit', $totalAmount ,$finalAmount, $tdsAmount ,$gstAmount , '$idOfAepsTransaction', @json)");
                }
