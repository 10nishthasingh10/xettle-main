        ...
        <table style="width: 100%;">
            <tr>
                <td style="background-color: #fff;">
                    <img alt="Logo" src="{{custom_secure_url('')}}/public/img/xettle_logo_new.png" style="width: 70px; padding: 20px">
                </td>
                <td style="padding-left: 50px; text-align: right; padding-right: 20px;">
                    <a href="{{env('APP_USERAPP_URL')}}/login" style="color: #261D1D; text-decoration: underline; font-size: 14px; letter-spacing: 1px;">
                        Login
                    </a>
                </td>
            </tr>
