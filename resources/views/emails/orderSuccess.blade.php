...
<html>
  <body style="background-color: #222533; padding: 20px; font-family: font-size: 14px; line-height: 1.43; font-family: &quot;Helvetica Neue&quot;, &quot;Segoe UI&quot;, Helvetica, Arial, sans-serif;">
    ...
    <div style="max-width: 600px; margin: 0px auto; background-color: #fff; box-shadow: 0px 20px 50px rgba(0,0,0,0.05);">
      ...
      </table><img alt="" src="{{url('img/email-header-img.jpg')}}" style="max-width: 100%; height: auto;">
      <div style="padding: 60px 70px;">
        <h2 style="margin-top: 0px;">
          Thanks for your order, {{$data->user->name}}!
        </h2>
        <div style="color: #636363; font-size: 14px;">
          Dear {{$data->user->name}}, thank you for shopping at our awesome store! We’re delighted we had what you were looking for! Your order should be processed and ready to be shipped within 24-48 hours. Below is your order confirmation. Please keep a copy for your records.
        </div>
