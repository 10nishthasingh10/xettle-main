    ...
    <div aria-hidden="true" aria-labelledby="exampleModalLabel" class="modal fade" id="addNewServiceModal" role="dialog" tabindex="-1">
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <form role="add-new-service-form" action="{{url('admin/global-billing/service/add')}}" method="POST">
                    @csrf
    ...
    <div aria-hidden="true" aria-labelledby="exampleModalLabel" class="modal fade" id="updateServiceModal" role="dialog" tabindex="-1">
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <form role="update-service-form" action="{{url('admin/global-billing/service/update')}}" method="POST">
                    @csrf
    ...
    <div aria-hidden="true" aria-labelledby="exampleModalLabel" class="modal fade" id="addUpdateProductsModal" role="dialog" tabindex="-1">
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <form role="add-update-product-form" action="{{url('admin/global-billing/products')}}" method="POST">
    ...
    <div aria-hidden="true" aria-labelledby="exampleModalLabel" class="modal fade" id="addUpdateProductFeeModal" role="dialog" tabindex="-1">
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <form role="add-update-product-fee-form" action="{{url('admin/global-billing/product-fee')}}" method="POST">
...
@if($role === 'super-admin')
<script src="{{asset('admin-js/global-billing.js')}}"></script>
@else
<script src="{{asset('admin-js/global-billing-support.js')}}"></script>
@endif
