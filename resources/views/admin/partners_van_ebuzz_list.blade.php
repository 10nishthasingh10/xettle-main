    ...
    <div class="content-box">
        <div class="element-wrapper">
            <div class="element-box">
                ...
                <form role="form-ebz-van-with-kyc" action="{{url('admin/van/eb/generate-info')}}" method="POST">
                    @csrf()
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="user_id">
                                        ...
                                        <option value="{{$row->id}}">{{$row->id}} - {{$row->name}} - {{$row->email}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-12 d-none" id="utr-response-data">
                        ...
                        <form role="form-ebz-van-with-kyc-final" action="{{url('admin/van/eb/create')}}" data-DataTables="datatable" method="POST">
                            <fieldset class="form-group">
                                @csrf()
                                <div class="col-md-12">
...
<div aria-hidden="true" aria-labelledby="exampleModalLabel" class="modal fade" id="uploadkycdoc" role="dialog" tabindex="-1">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="orderForm" enctype="multipart/form-data" role="upload-kyc-doc-form" action="{{url('admin/partners-van/ebuz-list/upload-kyc-doc')}}" data-DataTables="datatable" method="POST">
                @csrf
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var url = "{{custom_secure_url('admin/partners-van/report/ebuz-pvan-list')}}";
        var onDraw = function() {};
        var options = [{
