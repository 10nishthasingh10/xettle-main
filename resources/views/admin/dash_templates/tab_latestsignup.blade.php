                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="date-from_lst_signup" value="{{date('Y-m-d')}}" max="{{date('Y-m-d')}}" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="">To Date <span class="requiredstar"></span></label>
                                    <input type="date" name="date-to_lst_signup" value="{{date('Y-m-d')}}" max="{{date('Y-m-d')}}" class="form-control">
                                </div>
                            </div>
