...
<div aria-hidden="true" aria-labelledby="exampleModalLabel" class="modal fade" id="approveBatchOrderModal" role="dialog" tabindex="-1">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="orderForm" role="approve-request-form" action="{{url('admin/load-money-request/approve')}}" data-DataTables="datatable" method="POST">
                @csrf
...
<div aria-hidden="true" aria-labelledby="exampleModalLabel" class="modal fade" id="cancelBatchOrderModal" role="dialog" tabindex="-1">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="orderForm" role="cancel-request-form" action="{{url('admin/load-money-request/cancelled')}}" data-DataTables="datatable" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
                        <label for=""> Remarks </label>
...
<script>
    ...
    $(document).ready(function() {
        var url = "{{custom_secure_url('admin/fetch')}}/load-money-request/{{$id}}";
        var onDraw = function() {};
        var options = [{
