...
<div aria-hidden="true" aria-labelledby="exampleModalLabel" class="modal fade" id="rejectKycModal" role="dialog" tabindex="-1">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="rejectKycForm" role="reject-kyc-form" action="{{url('admin/users/video-kyc')}}" data-DataTables="datatable" method="POST">
                @csrf
...
<div aria-hidden="true" aria-labelledby="exampleModalLabel" class="modal fade" id="approveKycModal" role="dialog" tabindex="-1">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="approveKycForm" role="approve-kyc-form" action="{{url('admin/users/video-kyc')}}" data-DataTables="datatable" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
                        <label for=""> Remarks </label>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var url = "{{custom_secure_url('admin/fetch')}}/user-video-kyc/0";
        var onDraw = function() {};
        var options = [{
    ...
    $('#datatable').on('click', '.show-kyc-modal', function() {
        ...
        vid = `{{url('')}}/storage/app/public/videos/${vid}`;
