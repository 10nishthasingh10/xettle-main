                ...
                <form id="searchForm">
                    ...
                    <fieldset class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 xtl-inline-flex">
                                <div class="form-group">
...
<script id="details-template" type="text/x-handlebars-template">
    <table class="expandtable">
        <tr>
            <td><b>Merchant Txn Ref:</b> @{{merchant_txn_ref_id}}</td>
            <td><b>Bank Txn Id:</b> @{{bank_txn_id}}</td>
        </tr>
            <td><b>Payer Acc Name:</b> @{{payer_acc_name}}</td>
            <td><b>Mobile:</b> @{{payer_mobile}}</td>
        </tr>
        <tr>
            <td><b>Account No:</b> @{{payer_acc_no}}</td>
            <td><b>IFSC:</b> @{{payer_ifsc}}</td>
        </tr>
        <tr>
            <td><b>Order Id:</b> @{{original_order_id}}</td>
        </tr>
    </table>
</script>
<script>
...
<script type="text/javascript">
    $(document).ready(function() {
        var url = "{{custom_secure_url('admin/fetch')}}/upicallbacks_tpv/0";
        var onDraw = function() {};
        var options = [{
