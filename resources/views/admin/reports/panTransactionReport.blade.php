                            ...
                            <div class="row mb-xl-2 mb-xxl-3">
                                ...
                                <div class="col-sm-6">
                                    <a class="element-box el-tablo centered trend-in-corner bold-label text-success" href="#">
                                        ...
                                        {{empty(@$totalAmount[1]->totalCommissionCount) ? 0 : $totalAmount[1]->totalCommissionCount}}
                                        </div>
                                        <div class="label">
                                        Merchant
                                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var url = "{{custom_secure_url('admin/get')}}/panCard/0";
        var onDraw = function() { 
        };
        var options = [
            {
...
{
    $.ajax({
        url:"{{custom_secure_url('admin/reports/panCard')}}",
        type:'POST',
