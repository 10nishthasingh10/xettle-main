                ...
                <form id="searchForm">
                    <fieldset class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-control">
                                        ...
                                        <option value="0" @if(isset($_GET['status']) && $_GET['status']=='0' ) selected @endif>In Active</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-2">
                                <div class="row">
                                <input type="hidden" name="queryString" id="queryString" value="{{@$_GET['txn_id']}}" />
                                    <div class="col-md-12">
                                        <div class="form-group">
...
<div aria-hidden="true" aria-labelledby="exampleModalLabel" class="modal fade" id="addNewChargeModal" role="dialog" tabindex="-1">
    ...
    <form role="add-new-charge-form" action="{{url('admin/recharge-back/charge/add')}}" method="POST">
        @csrf
                ...
                <div class="row input_section" style="display:none">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text"  readonly="readonly" class="form-control addChargeInput customer_refid" value="{{$user->customer_ref_id}}" name="txn_id" placeholder="Enter txn id" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="">Amount <span class="requiredstar">*</span></label>
                            <input type="text"  readonly="readonly" class="form-control addChargeInput amount" name="amount" value="{{$user->amount}}" placeholder="Enter Amount" required>
                        </div>
                    </div>
                </div>
                <div class="row input_section" style="display:none">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text"  readonly="readonly" class="form-control addChargeInput bank_txnid" value="{{$user->bank_txn_id}}" name="bank_txn_id" placeholder="Enter txn id" required>
                            <!-- <input type="hidden" name="user_id" value="{{$user->id}}" /> -->
                        </div>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        var url = "{{custom_secure_url('admin/fetch')}}/recharge-back/0";
        var onDraw = function() {};
        var options = [{
            "data": "user",
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '#searchCharge', function(e){
            ...
            $.ajax({
                url: "{{ url('admin/recharge-back/charge/add') }}",
                type: 'POST',
                dataType: "json",
                data: {
