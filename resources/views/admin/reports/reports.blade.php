                    ...
                    <div class="col-sm-12 col-xxl-12">
                        <div class="tablos">
                            <div class="row mb-xl-2 mb-xxl-3">
                                <div class="col-sm-3">
                                    <a class="element-box el-tablo centered trend-in-corner bold-label text-success" href="{{url('admin/orders')}}">
                                        <div class="value font-1-1" id="smartPayoutTotal"></div>
                                        <div class="label">Smart Payout</div>
                                    </a>
                                </div>
                                <div class="col-sm-3">
                                    <a class="element-box el-tablo centered trend-in-corner bold-label text-success" href="{{url('admin/upiCallback')}}">
                                ...
                                <div class="col-sm-3">
                                    <a class="element-box el-tablo centered trend-in-corner bold-label text-success" href="{{url('admin/van-callback')}}">
                                        <div class="value font-1-1" id="partnerVANTotal"></div>
                                        <div class="label">Partner's VAN</div>
                                    </a>
                                </div>
                                <div class="col-sm-3">
                                    <a class="element-box el-tablo centered trend-in-corner bold-label text-success" href="{{url('admin/smart-collect/callbacks')}}">
                ...
                <div class="row">
                    <div class="col-sm-12 col-xxl-12">
                     <div class="tablos">
                            <div class="row">
                                <div class="col-sm-6">
                                    <a class="element-box el-tablo centered trend-in-corner bold-label text-danger" href="{{url('admin/reports/aeps')}}">
                                        <div class="value font-1-5" id="aepsTotal"></div>
                                        <div class="label text-dark">AEPS (Total Volume)</div>
                                    </a>
                                </div>
                                <div class="col-sm-6">
                                    <a class="element-box el-tablo centered trend-in-corner bold-label text-primary" href="{{url('admin/reports/aeps')}}">
   ...
   // getAepsRecords(from, to);
    ...
    function getPayoutRecords(from, to) {
        ...
        if (!isAjax) {
            ...
            $.ajax({
                url: "{{custom_secure_url('admin/allreports/payout')}}",
                type: 'POST',
                data: {
    ...
    function getUPIRecords(from, to) {
        $.ajax({
            url: "{{custom_secure_url('admin/allreports/upi')}}",
            type: 'POST',
            data: {
                _token: $('meta[name="csrf-token"]').attr('content'),
                from: from,
    ...
    function getVanRecords(from, to) {
        $.ajax({
            url: "{{custom_secure_url('admin/allreports/van')}}",
            type: 'POST',
            data: {
                _token: $('meta[name="csrf-token"]').attr('content'),
                from: from,
    ...
    function getAepsRecords(from, to) {
            ...
            $.ajax({
                url: "{{custom_secure_url('admin/allreports/aeps')}}",
                type: 'POST',
                data: {
                    _token: $('meta[name="csrf-token"]').attr('content'),
                    from: from,
