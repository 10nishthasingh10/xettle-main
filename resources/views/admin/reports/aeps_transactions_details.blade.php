                ...
                <form id="datatableFilterForm">
                    ...
                    <fieldset class="form-group">
                        ...
                        <div class="row">
                            ...
                            <input type="hidden" name="queryString" id="queryString" @if(isset($aadhaarNo)) value="{{$aadhaarNo}}" @endif />
                        </div>
                    </fieldset>
                </form>
...
<tr><td><b>Shop Name</b> </td>  <td><b>Shop Address</b> </td> <td><b>Shop Pin</b> </td><td><b>Address</b> </td><td><b>State</b> </td><td><b>District</b></td></tr>

<tr> <td>@{{shop_name}} </td> <td>@{{shop_address}} </td> <td>@{{shop_pin}} </td><td>@{{address}} </td><td>@{{state_name}} </td><td>@{{district_title}} </td> </tr>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var url = "{{custom_secure_url('admin/aeps-transactions-details')}}";
        // var onDraw = function() {};
        var options = [{
            ...
            },
            {
                "data": "tr_type",
                render: function(data, type, full, meta) {
                    return full.aadhaar_no;
                }
            },
            {
                "data": 'iin' , render: function(data, type, full, meta) {
                    if (data != null && data != '') {
                       return data;
                    }
                    return '';
            ...
            {
                "data": 'route_type', render: function(data, type, full, meta) {
                    return data.toUpperCase();
                }
            },
            {
