                            ...
                            <div class="row mb-xl-2 mb-xxl-3">
                                ...
                                <div class="col-sm-4">
                                    <a class="element-box el-tablo centered trend-in-corner bold-label text-success" href="#">
                                        ...
                                        {{@$totalAmount[3]->totalCommissionCount}} | ₹{{empty(@$totalAmount[3]->totalCommissionAmount) ? 0 : @$totalAmount[3]->totalCommissionAmount}}
                                        </div>
                                        <div class="label">
                                ...
                                <div class="col-sm-4"> 
                                    <a class="element-box el-tablo centered trend-in-corner bold-label text-danger" href="#">
                                        ...
                                        {{empty(@$totalAmount[1]->merchantCount) ? 0 : $totalAmount[1]->merchantCount}}
                                        </div>
                                        <div class="label">
                                            Merchants
                                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12 col-xxl-12">
                        <div class="tablos">
                            ...
                            <?php $trType = []?>
                                @foreach($totalAmount[4] as $trnCount)
                                ...
                                <div class="col-sm-4">
                                    <a class="element-box el-tablo centered trend-in-corner bold-label text-success" href="#">
                                        ...
                                        <div class="label">
                                        {{CommonHelper::case(@$trnCount->transaction_type, 'u')}}
                                        </div>
                                    </a>
                                </div>
                                @endforeach
                                <?php $result = array_diff($trType1, $trType); ?>
                                @foreach($result as $trTypes)
                                    <div class="col-sm-4">
                                        <a class="element-box el-tablo centered trend-in-corner bold-label text-success" href="#">
                                            <div class="value font-1-5" id="totalSuccessCountTxn">
                                            0
                    ...
                    <div class="col-sm-12 col-xxl-12">
                        <div class="tablos">
                            ...
                            <div class="row mb-xl-2 mb-xxl-3" id="lists">
                                @foreach($totalAmount[2] as $lists)
                                <div class="col-sm-3">
                                    <a class="element-box el-tablo centered trend-in-corner bold-label text-success" href="#">
                                        <div class="value font-1-5">
                                        {{@$lists->totalCount}} | ₹{{@$lists->totalAmount }}
                                    </div>
                                        <div class="label">
                                        {{CommonHelper::case($lists->route_type, 'u')}}
                                        </div>
                                    </a>
                                </div>
                                @endforeach
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var url = "{{custom_secure_url('admin/get')}}/aepsUsers/0";
        var onDraw = function() { 
        };
        var options = [
            {
...
{
    $.ajax({
        url:"{{custom_secure_url('admin/reports/aeps')}}",
        type:'POST',
...
function showMerchant(user_id) {
    ...
    $.post("{{url('admin/aeps/merchantList')}}",
        {
            user_id: user_id,
            from: from,
            to: to,
