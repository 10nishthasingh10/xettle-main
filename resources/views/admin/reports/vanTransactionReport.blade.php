                                ...
                                <div class="col-sm-5">
                                    <a class="element-box el-tablo centered trend-in-corner bold-label" href="#">
                                        <div class="value font-1-5" id="totalCount">
                                            {{$totalAmount[0]->totalCount + $totalAmount[1]->totalCount + $totalAmount[2]->totalCount}}
                                        </div>
                                        <div class="label">
                                            Total Counts
                                        </div>
                                ...
                                <div class="col-sm-4">
                                    <a class="element-box el-tablo centered trend-in-corner bold-label text-success" href="#">
                                        <div class="value font-1-5" id="totalCountVan">
                                            {{$totalAmount[0]->totalCount}} | ₹{{empty($totalAmount[0]->totalAmount)?0:number_format($totalAmount[0]->totalAmount,2)}}
                                        </div>
                                        <div class="label">
                                            Partner's VAN
                                        </div>
                                ...
                                <div class="col-sm-4">
                                    <a class="element-box el-tablo centered trend-in-corner bold-label text-primary" href="#">
                                        <div class="value font-1-5" id="totalCountUpiApi">
                                            {{$totalAmount[1]->totalCount}} | ₹{{empty($totalAmount[1]->totalAmount)?0:number_format($totalAmount[1]->totalAmount,2)}}
                                        </div>
                                        <div class="label">
                                            Smart Collect UPI
                                        </div>
                                ...
                                <div class="col-sm-4">
                                    <a class="element-box el-tablo centered trend-in-corner bold-label text-primary" href="#">
                                        <div class="value font-1-5" id="totalCountVanApi">
                                            {{$totalAmount[2]->totalCount}} | ₹{{empty($totalAmount[2]->totalAmount)?0:number_format($totalAmount[2]->totalAmount,2)}}
                                        </div>
                                        <div class="label">
                                            Smart Collect VAN
                                        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        var url = "{{custom_secure_url('admin/fetch-reports/van')}}";
        var url2 = "{{custom_secure_url('admin/fetch-reports/van-api')}}";
        var onDraw = function() {};
        var options = [{
    ...
    function getRecords(from, to) {
        ...
        $.ajax({
            url: "{{custom_secure_url('admin/reports/van')}}",
            type: 'POST',
            data: {
