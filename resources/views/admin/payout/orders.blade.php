...
<div class="content-w">
    ...
    <div aria-hidden="true" aria-labelledby="exampleModalLabel" class="modal fade" id="cancelOrderModal" role="dialog" tabindex="-1">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="orderForm" role="cancel-order-form" action="{{url('payout/order/cancelled')}}" data-DataTables="datatable" method="POST">
                    @csrf
    ...
    <script>
        ...
        $(document).ready(function() {
            var url = "{{custom_secure_url('admin/test')}}/orders/{{$id}}";
            var onDraw = function() {};
            var options = [{
