...
<div aria-hidden="true" aria-labelledby="exampleModalLabel" class="modal fade" id="addResellerModal" role="dialog" tabindex="-1">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form id="orderForm" role="add-reseller-form" action="{{url('admin/reseller/add-reseller')}}" data-DataTables="datatable" method="POST">
                    @csrf
...
<script>
    $(document).ready(function() {
        var url = "{{custom_secure_url('admin/fetch')}}/Resellers/0";
        var onDraw = function() {};
        var options = [ {
            "orderable": false,
            "searchable": false,
...
$.ajax({
    url:"{{url('admin/reseller/addReseller/')}}/"+id,
    type:"get",
