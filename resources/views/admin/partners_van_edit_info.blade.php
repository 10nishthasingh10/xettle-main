...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#datatable').on('click', '.update-info', function() {
            ...
            $.ajax({
                url: `{{url('')}}/admin/partners-van/get-info/${bizId}`,
                success: (result) => {
    ...
    $(document).ready(function() {
        ...
        var url = "{{custom_secure_url('admin/partners-van/report/edit-info')}}";
        var onDraw = function() {};
        var options = [{
    ...
    function setForm(response) {
        let res = `
        <form id="update-van-info-form" role="update-van-info-us-form" action="{{url('admin/partners-van/edit-info/submit')}}" data-DataTables="datatable" method="POST">
