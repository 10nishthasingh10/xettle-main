    ...
    <div aria-hidden="false" aria-labelledby="exampleModalLabel" class="modal fade" id="sendMessageModal" role="dialog" >
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="orderForm" role="assign-scheme-form" action="{{url('admin/messages/sendEmail')}}" data-DataTables="datatable" method="POST">
                    @csrf
    ...
    <div aria-hidden="true" aria-labelledby="exampleModalLabel" class="modal fade" id="addMessageModal" role="dialog" tabindex="-1">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="orderForm" role="add-message-form" action="{{url('admin/messages/addMessage')}}" data-DataTables="datatable" method="POST">
                    @csrf
                    <div class="modal-body">
...
<script>
    $(document).ready(function() {
        ...
        var url = "{{custom_secure_url('admin/fetch')}}/messages_list/0";
        var onDraw = function() {};
        var options = [ {
                "data": "subject"
            },
...
<script type="text/javascript">
    ...
    $('#datatable').on('click','.view-message',function(){
        ...
        $.ajax({
            url:"{{custom_secure_url('admin/messages/viewMessage/')}}"+"/"+id,
            type:'post',
            data:{id:id,"_token": "{{ csrf_token() }}"},
