...
<input type="hidden" id="dashboardBalances" value="{{custom_secure_url('admin/dashboard/balances')}}">
<input type="hidden" id="dashboardUsersAmount" value="{{custom_secure_url('admin/fetch-reports/dashboard-users-amount')}}">
...
<script src="{{asset('admin-js/dashboard.js?v=1.0.3')}}"></script>
