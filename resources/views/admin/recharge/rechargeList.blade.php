...
@section('title','Recharge Transactions')
@section('content')
<style type="text/css">
    .expandtable {
        width: 100% !important;
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var url = "{{custom_secure_url('admin/fetch')}}/rechargeTxn/0";
        var onDraw = function() {};
        var options = [{
                "data": "user",
            ...
            },
            {
                ...
                render: function(data, type, full, meta) {
                    var failedMessage = '';
                    if ("{{Auth::user()->hasRole('super-admin')}}" &&  (data == 'failed' ||  data == 'processed' || data == 'processing')) {
