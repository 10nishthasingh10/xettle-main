            ...
            <div class="element-box">
                ...
                <div class="row">
                    <div class="col-md-12 border rounded pt-4 pb-4">
                        <form class="form" method="post" role="upi-stack-settlement" action="{{custom_secure_url('admin/manual-settlement/upi-stack')}}">
                            @csrf()
                            <div class="row m-1">
                ...
                <div class="row">
                    <div class="col-md-12 border rounded pt-4 pb-4 d-none" id="utr-response-data">
                        ...
                        <form role="form-ebz-van-with-kyc-final" action="{{url('admin/manual-settlement/upi-stack-submit')}}" data-DataTables="datatable" method="POST">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var url = "{{custom_secure_url('admin/manual-settlement/report/upi-stack')}}";
        var onDraw = function() {};
        var options = [{
