    ...
    <div class="content-box">
        <div class="element-wrapper">
            <div class="element-box">
                ...
                <form id="rv-txn-form" role="rv-txn-us-form" action="{{url('admin/dispute-transactions/smart-collect/submit')}}" data-DataTables="datatable" method="POST">
                ...
                <div class="row">
                    <div class="col-md-12 d-none" id="utr-response-data">
                        ...
                        <form id="rv-txn-form-final" role="rv-txn-us-form-final" action="{{url('admin/dispute-transactions/smart-collect/final-submit')}}" data-DataTables="datatable" method="POST">
                            <fieldset class="form-group">
                                @csrf()
                                <div class="col-md-12">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var url = "{{custom_secure_url('admin/dispute-transactions/report/smart-collect')}}";
        var onDraw = function() {};
        var options = [{
