                                ...
                                <div class="col-sm-4">
                                    <a class="element-box el-tablo centered trend-in-corner bold-label text-success" href="#">
                                        <div class="value font-1-5" id="totalSuccessTxn">
                                            {{$totalAmount['success']->totalCount}} | ₹{{empty($totalAmount['success']->totalAmount)?0:$totalAmount['success']->totalAmount}}
                                        </div>
                                        <div class="label">
                                            Success
                                        </div>
                                ...
                                <div class="col-sm-4">
                                    <a class="element-box el-tablo centered trend-in-corner bold-label text-danger" href="#">
                                        <div class="value font-1-5" id="totalFailedTxn">
                                            {{$totalAmount['failed']->totalCount}} | ₹{{empty($totalAmount['failed']->totalAmount)?0:$totalAmount['failed']->totalAmount}}
                                        </div>
                                        <div class="label">
                                            Failed
                                        </div>
                                ...
                                <div class="col-sm-4">
                                    <a class="element-box el-tablo centered trend-in-corner bold-label text-primary" href="#">
                                        <div class="value font-1-5" id="totalReversedTxn">
                                            {{$totalAmount['reversed']->totalCount}} | ₹{{empty($totalAmount['reversed']->totalAmount)?0:$totalAmount['reversed']->totalAmount}}
                                        </div>
                                        <div class="label">
                                            Reversed
                                        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var url = "{{custom_secure_url('reseller/fetch-reports/payout')}}";
        var onDraw = function() {};
        var options = [{
                "orderable": false,
                "searchable": false,
    ...
    function getRecords(from, to) {
        ...
        $.ajax({
            url: "{{custom_secure_url('reseller/reports/payout')}}",
            type: 'POST',
            data: {
