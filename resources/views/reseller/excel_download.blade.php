...
<script>
    $(document).ready(function() {
        ...
        var url = "{{custom_secure_url('reseller/fetch')}}/exceldownload/{{Auth::user()->id}}";
        var onDraw = function() {};
        var options = [ {
                "data": "file_name"
            },
...
<script type="text/javascript">
    ...
    frm.submit(function (e) {
        ...
        var formData = new FormData(this);
            $.ajax(
                {
                    url: "{{url('/reseller/allreports/ajaxGenerateExcelFile')}}",
                    type: "POST",
                    data: formData,
                    contentType: false,
                    processData: false,
    ...
    function getExcelDataCount(count, interval) {
        $.ajax({
                type: "get",
                url: "{{url('reseller/allreports/getCountRecord')}}",
    ...
    function deleteFile(id)
    {
        ...
        {
            $.ajax({
                url:"{{custom_secure_url('reseller/removeExportFile/')}}"+"/"+id,
                type:"POST",
