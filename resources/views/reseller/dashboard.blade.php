	...
	<div class="element-box-tp">
		<div class="os-tabs-w">
			...
			<div class="tab-content">
				<!-- Tab Payout -->
				@include('admin.dash_templates.tab_payout')

				<!-- Tab AEPS -->
				@include('admin.dash_templates.tab_aeps')

				<!-- TAB DMT -->
				@include('admin.dash_templates.tab_dmt')

				<!-- TAB MATM -->
				@include('admin.dash_templates.tab_matm')

				<!-- TAB Recharge -->
				@include('admin.dash_templates.tab_recharge')

				<!-- TAB PAN Card -->
				@include('admin.dash_templates.tab_pancard')

				<!-- TAB Top Users -->
				@include('admin.dash_templates.tab_topusers')

				<!-- Last Transaction by User -->
				@include('admin.dash_templates.tab_activeusers')

				<!-- Last Transaction by User -->
				@include('admin.dash_templates.tab_latestsignup')
...
<input type="hidden" id="dashboardBalances" value="{{custom_secure_url('reseller/dashboard/balances')}}">
<input type="hidden" id="dashboardUsersAmount" value="{{custom_secure_url('reseller/fetch-reports/dashboard-users-amount')}}">

<input type="hidden" id="payoutGraphs" value="{{custom_secure_url('graphs/payout')}}">
<input type="hidden" id="aepsGraphs" value="{{custom_secure_url('graphs/aeps')}}">
<input type="hidden" id="dmtGraphs" value="{{custom_secure_url('graphs/dmt')}}">
<input type="hidden" id="matmGraphs" value="{{custom_secure_url('graphs/matm')}}">
<input type="hidden" id="rechargeGraphs" value="{{custom_secure_url('graphs/recharge')}}">
<input type="hidden" id="panGraphs" value="{{custom_secure_url('graphs/pan-card')}}">
...
<script src="{{asset('admin-js/reseller.js?v=1.0.3')}}"></script>
<script src="{{asset('admin-js/dashboard-aeps.js?v=1.0.0')}}"></script>
<script src="{{asset('admin-js/dashboard-dmt.js?v=1.0.0')}}"></script>
<script src="{{asset('admin-js/dashboard-matm.js?v=1.0.1')}}"></script>
<script src="{{asset('admin-js/dashboard-recharge.js?v=1.0.0')}}"></script>
<script src="{{asset('admin-js/dashboard-pancard.js?v=1.0.0')}}"></script>
<script>
	$(function() {
		$('.select2').select2({
