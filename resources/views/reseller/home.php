                ...
                <div class="element-balances" style="padding-left: 0px; justify-content: flex-start;">
                    <div class="balance ">
                        ...
                        <div class="balance-link">
                            <a class="btn btn-link btn-underlined" href="{{url('reseller/transactions')}}"><span>View Transactions</span><i class="os-icon os-icon-arrow-right4"></i></a>
                        </div>
                    </div>
