...
<meta name="user-token" content="{{encrypt(Auth::user()->id)}}">
@endsection
                    ...
                    <div class="os-tabs-w">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="tab_overview">
                                <form role="update-profile" action="{{custom_secure_url('user/accounts/profile-update')}}" method="post">
                                    @csrf
                                    <div class="row">
                                        <input type="hidden" name="user_id" value="{{encrypt(Auth::user()->id)}}" />
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for=""> Name</label><input class="form-control" placeholder="Enter Name" name="name" value="{{Auth::user()->name}}" @if(Auth::user()->is_profile_updated == '1')
                                                readonly="readonly"
                                                @endif
                                                type="text">
                                            </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="">Mobile *</label><input class="form-control" @if(Auth::user()->is_profile_updated == '1')
                                                readonly="readonly"
                                                @endif
                                                placeholder="Phone number" value="{{Auth::user()->mobile}}" name="mobile" type="number">
                                            </div>
                                        </div>

                                    </div>
                                    <div class="form-buttons-w text-right">
                                        @if(Auth::user()->is_profile_updated == '0') <button type="submit" name="update-profile" class="btn btn-primary" data-request="ajax-submit" data-target='[role="update-profile"]'>Update Profile</button> @endif
                                    </div>
                                </form>

                                <form role="change-password" action="{{custom_secure_url('user/accounts/profile-change-password')}}" method="post">
                                    @csrf
                                    <input type="hidden" name="user_id" value="{{encrypt(Auth::user()->id)}}" />
                                    <div class="row">
                                        <div class="col-sm-6">
                            ...
                            <div class="tab-pane" id="tab_sales">
                                <form role="update-business-profile" action="{{url('user/accounts/business-profile-update')}}" method="post">
                                    @csrf
                                    <input type="hidden" name="user_id" value="{{encrypt(Auth::user()->id)}}" />
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="business_name" @if(isset($data['business_info']->business_name))
                                                    readonly="readonly"
                                                    @endif
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="business_pan" @if(isset($data['business_info']->business_pan))
                                                    readonly="readonly"
                                                    @endif
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        ...
                                                        @else
                                                        value="{{Auth::user()->pan_owner_name}}"
                                                        @endif
                                                        name="pan_owner_name"
                                                        type="text">
                                                    </div>
                            ...
                            <div class="tab-pane " id="tab_bank">
                                ...
                                @else
                                <form role="update-bankDetails" action="{{url('user/accounts/update-bank-details')}}" method="post">
                                    @csrf
                                    <input type="hidden" name="user_id" value="{{encrypt(Auth::user()->id)}}" />
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" placeholder="Beneficiary Name" @if(isset($data['business_info']) && $data['business_info']->is_bank_updated == '1')
                                                readonly="readonly"
                                                @endif
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" placeholder="Branch IFSC Code" @if(isset($data['business_info']) && $data['business_info']->is_bank_updated == '1')
                                                    readonly="readonly"
                                                    @endif
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" placeholder="Account Number" @if(isset($data['business_info']) && $data['business_info']->is_bank_updated == '1')
                                                readonly="readonly"
                                                @endif
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" placeholder="Re-Enter Account Number" @if(isset($data['business_info']) && $data['business_info']->is_bank_updated == '1')
                                                    readonly="readonly"
                                                    @endif
                                    ...
                                    <div class="form-buttons-w text-right">
                                        @if(isset($data['business_info']) && $data['business_info']->is_bank_updated == '1') @else <button type="submit" name="update-business-profile" class="btn btn-primary" data-request="ajax-submit" data-target='[role="update-bankDetails"]'>Update Bank details</button> @endif
                                    </div>
                                </form>
                                @endif
                            ...
                            <div class="tab-pane " id="tab_api">
                                ...
                                <div class="element-box">
                                    <h5 class="form-header d-flex justify-content-between">
                                        API Overview
                                        @if(CommonHelper::isServiceActive(Auth::user()->id,PAYOUT_SERVICE_ID) || CommonHelper::isServiceActive(Auth::user()->id,AEPS_SERVICE_ID) || CommonHelper::isServiceActive(Auth::user()->id,UPI_SERVICE_ID))
                                ...
                                <div class="element-box">
                                    <h5 class="form-header d-flex justify-content-between">
                                        ...
                                        @endif
                                        @if((isset($user_config->is_sdk_enable) && $user_config->is_sdk_enable == '1') && CommonHelper::isServiceActive(Auth::user()->id, MATM_SERVICE_ID))
