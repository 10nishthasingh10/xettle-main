        ...
        <div class="row">
            ...
            <div class="col-sm-3 col-md-3">
                <a class="element-box el-tablo" href="#">
                    ...
                    <div class="value" style="font-size: 1.43rem;" id="currentBusinessData">₹ {{number_format($successAmount->amt,2)}}</div>
...
<div class="row">
    <div class="col-sm-12 col-md-12">
        <div class="element-wrapper">
            <div class="element-actions">
                <a class="btn btn-primary btn-sm" href="{{url('upi/upicallbacks')}}"><i class="os-icon os-icon-eye"></i><span>View More</span></a>
            </div>
...
<script>
    ...
    //     $.getJSON(`{{secure_url('upi/dashboard-chart')}}/` + searchText, function(response) {
...
<script src="{{asset('user-js/user-upi-stack-dashboard.js')}}"></script>
@endsection