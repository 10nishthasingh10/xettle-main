...
<script src="{{url('public/js/buttons.print.min.js')}}"></script>
    ...
    <table class="expandtable">
		...
		<tr><td><b>Code :</b></td><td> @{{code}}</td><td><b>Customer Ref Id :</td><td>@{{customer_ref_id}}</td><td><b>Payer Acc Name:</td><td>@{{payer_acc_name}}</td>
        </tr>
...
$(document).ready(function () {
        var url = "{{custom_secure_url('upi/fetch')}}/UPICollects/0";
        var onDraw = function() {
        };
        var options = [
            {
