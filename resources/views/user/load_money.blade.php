...
<div class="content-w">
    <div class="content-box custom-content-box">
        <div class="element-wrapper">
            ...
            @if(CommonHelper::isLoadMoneyRequestActive(Auth::user()->id))
            <div class="element-box">
                <h5 class="form-header">
                    {{$page_title}}
                </h5>
                <form role="make-money-request" action="{{url('user/ajax/load-money-request')}}" method="POST">
                    @csrf
...
<script>
    ...
    $(document).ready(function() {
        var url = "{{custom_secure_url('user/fetch')}}/load-money-request/{{$id}}";
        var onDraw = function() {};
        var options = [{
