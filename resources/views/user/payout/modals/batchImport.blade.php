<div class="onboarding-modal modal fade animated" id="kt_modal_batch_import" tabindex="-1" aria-hidden="true">
	...
	<div class="modal-dialog ">
		...
		<div class="modal-content">
			...
			<!--end::Modal header-->
			<!--begin::Form-->
			<form id="kt_modal_create_api_ip_form" class="form" method="post" role="update-ip" action="{{url('payout/import-batch-file')}}" enctype="multipart/form-data">
				@csrf
				...
				<div class="modal-footer flex-center">
					<!--begin::Button-->
					<a href="{{url('public/doc/xettle_sample_batch_payouts.csv')}}" class="btn btn-sm btn-success" id="" download>Download Sample</a>
					<!--end::Button-->
					<!--begin::Button-->
