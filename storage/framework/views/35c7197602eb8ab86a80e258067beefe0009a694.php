        ...
        <div class="element-wrapper">
            <div class="element-box">
                ...
                <div class="element-actions">
                    <?php if(CommonHelper::isServiceActive(Auth::user()->id,PAYOUT_SERVICE_ID)): ?>

                    <?php if(CommonHelper::isServiceEnabled(Auth::user()->id,PAYOUT_SERVICE_ID)): ?>
...
<div aria-hidden="true" aria-labelledby="exampleModalLabel" class="modal fade" id="cancelBatchOrderModal" role="dialog" tabindex="-1">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="orderForm" role="cancel-order-form" action="<?php echo e(url('payout/batch/cancelled')); ?>" data-DataTables="datatable" method="POST">
                <?php echo csrf_field(); ?>
...
<script>
    function bulkPayoutDownload(id) {
        $.ajax({
            url: "<?php echo e(custom_secure_url('payout/bulkExport/')); ?>/" + id,
            type: "get",
...
<script>
    ...
    $(document).ready(function() {
        var url = "<?php echo e(custom_secure_url('payout/fetch')); ?>/bulkpayouts/<?php echo e($id); ?>";
        var onDraw = function() {};
        var options = [{
...
<script type="text/javascript">
    ...
    function bulkPayoutApprove(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: "<?php echo e(custom_secure_url('payout/bulkPayout/approveOtp/')); ?>/" + id,
                    method: 'GET',
    ...
    $(document).on('click', '#resendOtpOrder', function() {
        ...
        $.ajax({
            url: "<?php echo e(custom_secure_url('payout/resendOtpOrderApprove/')); ?>/" + userId,
            method: 'POST',
            async: false,
            data: {
                '_token': $token
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xettle-main\resources\views/user/payout/bulkpayout/list.blade.php ENDPATH**/ ?>