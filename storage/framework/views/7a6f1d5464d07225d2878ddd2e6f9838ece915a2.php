...
<input type="hidden" id="dashboardBalances" value="<?php echo e(secure_url('admin/dashboard/balances')); ?>">
<input type="hidden" id="dashboardUsersAmount" value="<?php echo e(secure_url('admin/fetch-reports/dashboard-users-amount')); ?>">

<input type="hidden" id="payoutGraphs" value="<?php echo e(secure_url('graphs/payout')); ?>">
<input type="hidden" id="aepsGraphs" value="<?php echo e(secure_url('graphs/aeps')); ?>">
<input type="hidden" id="dmtGraphs" value="<?php echo e(secure_url('graphs/dmt')); ?>">
<input type="hidden" id="matmGraphs" value="<?php echo e(secure_url('graphs/matm')); ?>">
<input type="hidden" id="rechargeGraphs" value="<?php echo e(secure_url('graphs/recharge')); ?>">
<input type="hidden" id="panGraphs" value="<?php echo e(secure_url('graphs/pan-card')); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pgpaysecureco/public_html/resources/views/admin/home.blade.php ENDPATH**/ ?>