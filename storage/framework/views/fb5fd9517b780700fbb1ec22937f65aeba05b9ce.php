<div class="onboarding-modal modal fade animated" id="kt_modal_create_ipwhite" tabindex="-1" aria-hidden="true">
	...
	<div class="modal-dialog ">
		...
		<div class="modal-content">
			...
			<!--end::Modal header-->
			<!--begin::Form-->
			<form id="kt_modal_create_api_ip_form" class="form" method="post" data-dataTables="ip_list_table" role="update-ip" action="<?php echo e(secure_url('user/accounts/add-ip')); ?>">
				<?php echo csrf_field(); ?>
	...
	<!--end::Modal dialog-->
</div><?php /**PATH /home/pgpaysecureco/public_html/resources/views/user/payout/modals/ip.blade.php ENDPATH**/ ?>