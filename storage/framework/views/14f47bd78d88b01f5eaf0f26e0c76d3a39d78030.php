...
<?php $__env->startSection('scripts'); ?>
    ...
    <table class="expandtable">
        <tr>
            <td><b>AAdhar No :</b></td><td>{{mask aadhaar_no}}</td><td><b>Mobile No :</b></td><td>{{mobileMask mobile_no}}</td><td><b>Transaction Date :</b></td><td>{{transaction_date}}</td>
...
$(document).ready(function () {
        var url = "<?php echo e(secure_url('aeps/fetch')); ?>/aepsSettlement/0";
        var onDraw = function() {
        };
        var options = [
...
<?php echo $__env->make('layouts.user.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pgpaysecureco/public_html/resources/views/user/aeps/aepssettlement.blade.php ENDPATH**/ ?>