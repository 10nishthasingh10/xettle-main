...
$(document).ready(function () {
        var url = "<?php echo e(secure_url('admin/fetch')); ?>/upiCallbackTransaction/<?php echo e($user['id']); ?>";
        var onDraw = function() {
        };
        var options = [
            {
...
function vanTransaction(){
        var url1 = "<?php echo e(secure_url('admin/fetch')); ?>/vanTransaction/<?php echo e($user['id']); ?>";
        var onDraw = function() {
        };
        var options = [
            {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pgpaysecureco/public_html/resources/views/admin/reports/userDetails.blade.php ENDPATH**/ ?>