...
<script id="details-template" type="text/x-handlebars-template">
    <table class="expandtable table table-sm">
        ...
        <tr>
            <td><b>Bank Reff. ID :</b> {{reference_id}}</td>
            <td><b>Amount Credited :</b> {{is_trn_credited}}</td>
            <td><b>Credited Time :</b> {{trn_credited_at}}</td>
        </tr>
        <tr>
...
<script>
    ...
    $(document).ready(function() {
        var url = "<?php echo e(custom_secure_url('admin/fetch')); ?>/autocollect_callbacks";
        var onDraw = function() {};
        var options = [{
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xettle-main\resources\views/admin//reports/smart_collect_callback.blade.php ENDPATH**/ ?>