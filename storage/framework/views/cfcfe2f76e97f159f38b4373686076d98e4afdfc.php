...
<script>
    ...
    $(document).ready(function() {
        var url = "<?php echo e(secure_url('payout/fetch')); ?>/bulkpayouts/<?php echo e($id); ?>";
        var onDraw = function() {};
        var options = [{
...
<script type="text/javascript">
    ...
    function bulkPayoutApprove(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: "<?php echo e(secure_url('payout/bulkPayout/approveOtp/')); ?>/" + id,
                    method: 'GET',
    ...
    $(document).on('click', '#resendOtpOrder', function() {
        ...
        $.ajax({
            url: "<?php echo e(secure_url('payout/resendOtpOrderApprove/')); ?>/" + userId,
            method: 'POST',
            async: false,
            data: {
                '_token': $token
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pgpaysecureco/public_html/resources/views/user/payout/bulkpayout/list.blade.php ENDPATH**/ ?>