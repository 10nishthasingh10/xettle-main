                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select name="service_id" class="form-control">
                                        ...
                                        <option value="<?php echo e($row->service_id); ?>"><?php echo e($row->title); ?></option>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select name="is_active" class="form-control">
                                        ...
                                        <option value="1" <?php if(isset($_GET['is_active']) && $_GET['is_active']=='1' ): ?> selected <?php endif; ?>>Active</option>
                                        <option value="0" <?php if(isset($_GET['is_active']) && $_GET['is_active']=='0' ): ?> selected <?php endif; ?>>In Active</option>
                                    </select>
                                </div>
                            </div>
...
<script>
    $(document).ready(function() {
        var url = "<?php echo e(secure_url('admin/fetch')); ?>/serviceRequest/0";
        var onDraw = function() {};
        var options = [{
                "data": "user_id",
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pgpaysecureco/public_html/resources/views/admin//reports/servicerequest.blade.php ENDPATH**/ ?>