<?php $__env->startSection('title','Aeps Transactions'); ?>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var url = "<?php echo e(custom_secure_url('admin/fetch')); ?>/aepsTransaction/0";
        var onDraw = function() {};
        var options = [{
                "data": "user",
            ...
            },
            {
                ...
                render: function(data, type, full, meta) {
                    var failedMessage = '';
                    if ("<?php echo e(Auth::user()->hasRole('super-admin')); ?>" &&  (data == 'failed' ||  data == 'success' || data == 'pending')) {
    ...
    function aepsStatus(merchantCode, orderId, amount, status, agentId) {
        ...
        $.ajax({
            ...
            method:"post",
            data:{'clientRefId': orderId, 'merchantCode' : merchantCode, '_token': "<?php echo e(csrf_token()); ?>"},
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xettle-main\resources\views/admin/aeps/aeps_transactions.blade.php ENDPATH**/ ?>