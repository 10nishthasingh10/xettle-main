        ...
        <div class="col-sm-12 col-lg-8 col-xxl-7">
            <div class="element-balances justify-content-between mobile-full-width">
                <div class="balance balance-v2">
                    ...
                    <div class="balance-value">
                        <span class="d-xxl-none">₹<?php echo e(CommonHelper::payoutDashboard(Auth::user()->id)->transaction_amount); ?></span>
                        <span class="d-none d-xxl-inline-block">₹<?php echo e(CommonHelper::payoutDashboard(Auth::user()->id)->transaction_amount); ?></span>
                        <span class="trending trending-down-basic">
                            ...
                            ?>
                            ₹<?php echo e(number_format($lockedAmount, 2)); ?>
            ...
            <div class="element-wrapper pb-4 mb-4 border-bottom">
                <div class="element-box-tp">
                    <a class="btn btn-primary" href="<?php echo e(secure_url('user/dashboard')); ?>">
                        <i class="os-icon os-icon-refresh-ccw"></i><span>Add Balance</span>
                    </a>
                    <a class="btn btn-grey" href="<?php echo e(url('payout/bulk')); ?>"><i class="os-icon os-icon-log-out"></i><span>Upload Bulkpayout</span></a>
                </div>
            </div>
        ...
        <div class="col-sm-12 col-lg-4 col-xxl-5 d-none d-lg-block">
            <div class="cta-w cta-with-media purple" style="height: 90%">
                <div class="cta-content">
                    ...
                    <a class="store-google-btn" href="#"><img alt="" src="<?php echo e(url('public/img/button-view-docs.png')); ?>"></a>
                </div>
                <div class="cta-media">
                    <img alt="" src="<?php echo e(url('public/img/side-media.png')); ?>">
                </div>
            </div>
        </div>
...
<script src="<?php echo e(asset('user-js/user-payout-dashboard.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pgpaysecureco/public_html/resources/views/user/payout/index.blade.php ENDPATH**/ ?>