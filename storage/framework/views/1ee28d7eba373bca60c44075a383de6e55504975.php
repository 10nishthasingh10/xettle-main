<div class="menu-w selected-menu-color-light menu-activated-on-hover menu-has-selected-link color-scheme-dark color-style-default sub-menu-color-dark menu-position-side menu-side-left menu-layout-mini sub-menu-style-over">
    ...
    <ul class="main-menu">
        ...
        <li class="selected has-sub-menu">
            <?php if(Request::is('payout/*') || Request::is('payout') || Request::is('upi') || Request::is('upi/*') || Request::is('aeps') || Request::is('aeps/*') || Request::is('collect/*') || Request::is('collect') || Request::is('va/*') || Request::is('va') || Request::is('verification/*') || Request::is('verification')): ?>
       ...
       <!-- <li class=" has-sub-menu">
            <a href="<?php echo e(url('/user/van-callbacks')); ?>">
                <div class="icon-w">
                    <div class="os-icon os-icon-bar-chart"></div>
                </div>
                <span>VAN Transactions</span>
            </a>
            <div class="sub-menu-w">
                <div class="sub-menu-header">
                    VAN Transactions
...
</div><?php /**PATH /home/pgpaysecureco/public_html/resources/views/include/user/sidebar.blade.php ENDPATH**/ ?>