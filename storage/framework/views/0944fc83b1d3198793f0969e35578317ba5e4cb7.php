...
<div aria-hidden="true" aria-labelledby="exampleModalLabel" class="modal fade" id="addMessageModal" role="dialog" tabindex="-1">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form id="orderForm" role="add-message-form" action="<?php echo e(url('admin/offer/add-category')); ?>" data-DataTables="datatable" method="POST">
                    <?php echo csrf_field(); ?>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var url = "<?php echo e(custom_secure_url('admin/fetch')); ?>/category_list/0";
        var onDraw = function() {};
        var options = [ {
                "data": "title"
            },
    ...
    $('#datatable').on('click','.edit-offer',function(){
        ...
        $.ajax({
            url:"<?php echo e(url('admin/offer/getOfferCategory/')); ?>/"+id,
            type:"get",
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xettle-main\resources\views/admin/offers/category.blade.php ENDPATH**/ ?>