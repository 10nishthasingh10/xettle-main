...
<head>
    ...
    <meta name="base-url" content="<?php echo e(custom_secure_url('')); ?>">
    ...
    <link href="<?php echo e(asset('css/main.css?version=4.5.1')); ?>" rel="stylesheet">
    ...
    <style type="text/css">
        ...
        td.details-control {
            background: url("<?php echo e(custom_secure_url('')); ?>/public/images/details_open.png") no-repeat center center;
            cursor: pointer;
        }

        tr.shown td.details-control {
            background: url("<?php echo e(custom_secure_url('')); ?>/public/images/details_close.png") no-repeat center center;
        }
    </style>
    <style>
    </style>
...
<body class="menu-position-side menu-side-left">
    ...
    <div class="xtl_loader_container d-none" id="xtl_loader_container">
        <div class="xtl_loader_content">
            <div class="image_box">
                <img src="<?php echo e(asset('img/xettle_logo_new.png')); ?>" class="w-100" />
            </div>
    ...
    <?php if(Request::is('admin/userprofile/*')): ?>
    ...
    <div class="all-wrapper with-side-panel solid-bg-all">
      ...
      -------------------->
        ...
        -------------------->
                    ...
                    <div class="menu-and-user d-md-block ">
                        <ul class="main-menu">
                            ...
                            <li class="has-sub-menu">
                                ...
                                <ul class="sub-menu">
                                    <li>
                                        <a href="<?php echo e(url('/admin/recharges')); ?>">Recharges</a>
                                    </li>
                                </ul>
                            </li>
                            <!-- <li class="has-sub-menu">
                                <a href="<?php echo e(url('admin/ocr')); ?>">
                                ...
                                <ul class="sub-menu">
                                    <li>
                                        <a href="<?php echo e(url('/admin/ocr')); ?>">OCR</a>
                                    </li>
                                </ul>
                            ...
                            <li class=" has-sub-menu">
                                ...
                                <ul class="sub-menu">
                                    <li>
                                        <a href="<?php echo e(url('/admin/auto-settlements')); ?>">Auto Settlements</a>
                                    </li>
                                </ul>
                            </li>
                            <?php endif; ?>
                            ...
                            <li class="has-sub-menu">
                                ...
                                <div class="sub-menu-w">
                                    <ul class="sub-menu">
                                        ...
                                        <li>
                                            <a href="<?php echo e(url('admin/aeps/transactions')); ?>">Transaction</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                ...
                <?php echo $__env->make('include.common.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

                <div class="content-w">
                    <?php echo $__env->make('include.common.topbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <div class="content-i">
                ...
                $('#filterUTR').keydown(function(event) {
                    ...
                    if (event.keyCode == 13) {
                        ...
                        if (filterutr.length > 4) {
                            var url = "<?php echo e(url('admin/filterutr')); ?>/" + filterutr;
...
</html><?php /**PATH C:\xampp\htdocs\xettle-main\resources\views/layouts/admin/app.blade.php ENDPATH**/ ?>