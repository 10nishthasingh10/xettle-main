...
<script>
    $(document).ready(function() {
        ...
        var url = "<?php echo e(custom_secure_url('user/fetch')); ?>/exceldownload/<?php echo e(Auth::user()->id); ?>";
        var onDraw = function() {};
        var options = [ {
                "data": "file_name"
            },
...
<script type="text/javascript">
    ...
    frm.submit(function (e) {
        ...
        var formData = new FormData(this);
            $.ajax(
                {
                    url: "<?php echo e(url('/user/allreports/ajaxGenerateExcelFile')); ?>",
                    type: "POST",
                    data: formData,
                    contentType: false,
                    processData: false,
    ...
    function getExcelDataCount(count, interval) {
        $.ajax({
                type: "get",
                url: "<?php echo e(url('user/allreports/getCountRecord')); ?>",
    ...
    function deleteFile(id)
    {
        ...
        {
            $.ajax({
                url:"<?php echo e(custom_secure_url('user/removeExportFile/')); ?>"+"/"+id,
                type:"POST",
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xettle-main\resources\views/user//download/list.blade.php ENDPATH**/ ?>