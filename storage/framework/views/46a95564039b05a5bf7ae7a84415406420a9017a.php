                            ...
                            <div class="col-md-2">
                                ...
                                <label for="">Filter by Pipe:</label>
                                    <select  class="form-control js-example-basic-multiple" multiple="" name="allpipe" id="allpipe[]">
                                        <?php $__currentLoopData = $Pipe; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pipes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($pipes->id); ?>">
                                            <?php echo e($pipes->pipeName); ?> 
                                        </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var url = "<?php echo e(custom_secure_url('admin/fetch')); ?>/users/0";
        var onDraw = function() {};
        var options = [{
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xettle-main\resources\views/admin/reports/users.blade.php ENDPATH**/ ?>