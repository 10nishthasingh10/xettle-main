...
<script id="details-template" type="text/x-handlebars-template">
    ...
    <table class="expandtable">
		...
		<tr><td><b>Merchant Txn :</b></td><td> {{merchant_txn_ref_id}}</td><td><b>MCC :</td><td>{{mcc}}</td><td><b>Request Id:</td><td>{{request_id}}</td>
        </tr>
        </table>
</script>
<script>
...
<script type="text/javascript">
    $(document).ready(function() {
        var url = "<?php echo e(custom_secure_url('admin/fetch')); ?>/merchants/0";
        var onDraw = function() {};
        var options = [{
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xettle-main\resources\views/admin//reports/merchant.blade.php ENDPATH**/ ?>