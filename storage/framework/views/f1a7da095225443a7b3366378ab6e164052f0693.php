                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="date" id="fromDate" name="from" class="form-control" <?php if(isset($_GET['from'])): ?> value="<?php echo e($_GET['from']); ?>"  <?php endif; ?> />
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="">To Date <span class="requiredstar"></span></label>
                                    <input type="date" id="toDate" name="to" class="form-control"  <?php if(isset($_GET['to'])): ?> value="<?php echo e($_GET['to']); ?>"  <?php endif; ?>/>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
...
<script>
    ...
    $(document).ready(function() {
        var url = "<?php echo e(custom_secure_url('admin/fetch')); ?>/aeps_agents/0";
        var is_view_action = "<?php echo e($is_view_action); ?>";
        var is_delete_action = "<?php echo e($is_delete_action); ?>";
        var onDraw = function() {};
        var options = [
            {
                "data": "first_name",
...
<script type="text/javascript">
    ...
    function changeStatus(id,action)
    {
        ...
        {
            $.ajax({
                url:"<?php echo e(custom_secure_url('admin/aeps/changeAgentStatus')); ?>",
                type:'POST',
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xettle-main\resources\views/admin/aeps/agents_list.blade.php ENDPATH**/ ?>