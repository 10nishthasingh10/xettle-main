...
<script>
    ...
    $(document).ready(function() {
        var url = "<?php echo e(secure_url('admin/fetch')); ?>/load-money-request/<?php echo e($id); ?>";
        var onDraw = function() {};
        var options = [{
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pgpaysecureco/public_html/resources/views/admin/load_money.blade.php ENDPATH**/ ?>