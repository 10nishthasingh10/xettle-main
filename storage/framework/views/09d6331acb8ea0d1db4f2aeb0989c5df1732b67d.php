                                ...
                                <div class="col-sm-6">
                                    <a class="element-box el-tablo centered trend-in-corner bold-label text-success" href="#">
                                        <div class="value font-1-5" id="totalUpiqrTxn">
                                            <?php echo e($totalAmount['upi_qr']->totalCount); ?> | ₹<?php echo e(empty($totalAmount['upi_qr']->totalAmount)?0:$totalAmount['upi_qr']->totalAmount); ?>
                                ...
                                <div class="col-sm-6">
                                    <a class="element-box el-tablo centered trend-in-corner bold-label text-primary" href="#">
                                        <div class="value font-1-5" id="totalUpiStackFeeTax">
                                            <?php echo e($totalAmount['upi_fee_tax']->totalCount??'0'); ?> | ₹<?php echo e(empty($totalAmount['upi_fee_tax']->totalAmount)?0:$totalAmount['upi_fee_tax']->totalAmount??'0'); ?>
                                ...
                                <div class="col-sm-6">
                                    <a class="element-box el-tablo centered trend-in-corner bold-label text-primary" href="#">
                                        <div class="value font-1-5" id="totalUpiCollectTxn">
                                            <?php echo e($totalAmount['upi_creation']->totalCount??'0'); ?> | ₹<?php echo e(empty($totalAmount['upi_creation']->totalAmount)?0:$totalAmount['upi_creation']->totalAmount??'0'); ?>
                                ...
                                <div class="col-sm-6">
                                    <a class="element-box el-tablo centered trend-in-corner bold-label text-info" href="#">
                                        <div class="value font-1-5" id="totalUpiVerifyTxn">
                                            <?php echo e($totalAmount['upi_verify']->totalCount??'0'); ?> | ₹<?php echo e(empty($totalAmount['upi_verify']->totalAmount??'0')?0:$totalAmount['upi_verify']->totalAmoun??'0'); ?>
...
<script type="text/javascript">
    $(document).ready(function() {
        var url = "<?php echo e(custom_secure_url('admin/fetch-reports/upi')); ?>";
        var onDraw = function() {};
        var options = [{
                "orderable": false,
                "searchable": false,
    ...
    function getRecords(from, to) {
        ...
        $.ajax({
            url: "<?php echo e(custom_secure_url('admin/reports/upi')); ?>",
            type: 'POST',
            data: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xettle-main\resources\views/admin/reports/upiTransactionReport.blade.php ENDPATH**/ ?>