	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form id="kt_modal_create_api_key_form" class="form" method="post" action="<?php echo e(url('user/accounts/api-key-generate')); ?>" data-dataTables="kt_api_keys_table">
					<?php echo csrf_field(); ?>
...
</div><?php /**PATH /home/pgpaysecureco/public_html/resources/views/user/payout/modals/apikey.blade.php ENDPATH**/ ?>