            ...
            <div class="element-box">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 border rounded pt-4 pb-4">
                        <form class="form" method="post" role="smart-collect-settlement" action="<?php echo e(custom_secure_url('admin/manual-settlement/smart-collect')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="row m-1">
                ...
                <div class="row">
                    <div class="col-md-12 border rounded pt-4 pb-4 d-none" id="utr-response-data">
                        ...
                        <form role="form-ebz-van-with-kyc-final" action="<?php echo e(url('admin/manual-settlement/smart-collect-submit')); ?>" data-DataTables="datatable" method="POST">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var url = "<?php echo e(custom_secure_url('admin/manual-settlement/report/smart-collect')); ?>";
        var onDraw = function() {};
        var options = [{
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xettle-main\resources\views/admin/manual_settlements/smart_collect.blade.php ENDPATH**/ ?>