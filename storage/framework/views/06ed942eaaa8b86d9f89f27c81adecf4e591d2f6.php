<div
    ...
    <ul class="main-menu">
        ...
        <?php if(Auth::user()->hasRole('reseller') && request()->is('reseller/*')): ?>
            <li class="has-sub-menu">
                ...
                <div class="sub-menu-w">
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a href="<?php echo e(url('reseller/transactions')); ?>">Transactions</a>
                        </li>
                    </ul>
                </div>
            </li>
            <li class="has-sub-menu">
                ...
                <div class="sub-menu-w">
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a href="<?php echo e(url('reseller/list')); ?>">List</a>
                        </li>
                    </ul>
                </div>
            </li>
            <li class="has-sub-menu">
                ...
                <div class="sub-menu-w">
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a href="<?php echo e(url('reseller/upicollect')); ?>">UPICollect</a>
                        </li>
                    </ul>
                </div>
            </li>
            <li class="has-sub-menu">
                ...
                <div class="sub-menu-w">
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a href="<?php echo e(url('reseller/payout')); ?>">Payout</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class=" has-sub-menu">
                ...
                <div class="sub-menu-w">
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a href="<?php echo e(url('reseller/reports/payout')); ?>">Payout</a>
                        </li>
                        <li>
                            <a href="<?php echo e(url('reseller/reports/upi')); ?>">UPI</a>
                        </li>
                        </li>
                    </ul>
                </div>
            ...
            <li class=" has-sub-menu">
                ...
                <div class="sub-menu-w">
                    ...
                    <ul class="sub-menu">
                        ...
                        <?php endif; ?>
                        <?php if(Auth::user()->hasRole('accountant') || Auth::user()->hasRole('super-admin') || Auth::user()->hasRole('finance') || Auth::user()->hasRole('reseller')): ?>
                            <li>
        ...
        <?php if(Auth::user()->hasRole('super-admin') || Auth::user()->hasRole('support') || Auth::user()->hasRole('accountant')): ?>
            ...
            <li class="has-sub-menu">
                <a href="<?php echo e(url('admin/recharge-back')); ?>">
                    <div class="icon-w p-2">
            ...
            <li class="has-sub-menu">
                <a href="<?php echo e(url('admin/integration/viewpipetxn')); ?>">
                    <div class="icon-w p-2">
            ...
            <li class="has-sub-menu">
                <a href="<?php echo e(url('admin/reseller')); ?>">
                    <div class="icon-w p-2">
            ...
            <li class="has-sub-menu">
                <a href="<?php echo e(url('admin/integration')); ?>">
                    <div class="icon-w p-2">
            ...
            <li class="has-sub-menu">
                ...
                <div class="sub-menu-w">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a href="<?php echo e(url('/admin/activitylogs')); ?>">ActivityLog</a>
                        </li>
                    </ul>
                </div>
            </li>
...
<?php /**PATH C:\xampp\htdocs\xettle-main\resources\views/include/common/sidebar.blade.php ENDPATH**/ ?>