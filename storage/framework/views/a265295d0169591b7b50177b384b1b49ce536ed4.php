                    ...
                    <div class="os-tabs-w">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="tab_overview">
                                <form role="update-profile" action="<?php echo e(secure_url('user/accounts/profile-update')); ?>" method="post">
                                    <?php echo csrf_field(); ?>
                                    <div class="row">
                                ...
                                <form role="change-password" action="<?php echo e(secure_url('user/accounts/profile-change-password')); ?>" method="post">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="user_id" value="<?php echo e(encrypt(Auth::user()->id)); ?>" />
                                    <div class="row">
                                        <div class="col-sm-6">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pgpaysecureco/public_html/resources/views/user/myprofile.blade.php ENDPATH**/ ?>