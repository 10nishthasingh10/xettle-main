                            ...
                            <div class="row mb-xl-2 mb-xxl-3">
                                ...
                                <div class="col-sm-6">
                                    <a class="element-box el-tablo centered trend-in-corner bold-label text-success" href="#">
                                        ...
                                        <?php echo e(@$totalAmount[1]->totalCommissionCount); ?> | ₹<?php echo e(empty(@$totalAmount[3]->totalCommissionAmount) ? 0 : @$totalAmount[1]->totalCommissionAmount); ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var url = "<?php echo e(custom_secure_url('admin/get')); ?>/recharge/0";
        var onDraw = function() { 
        };
        var options = [
            {
...
{
    $.ajax({
        url:"<?php echo e(custom_secure_url('admin/reports/recharge')); ?>",
        type:'POST',
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xettle-main\resources\views/admin/reports/rechargeTransactionReport.blade.php ENDPATH**/ ?>