...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#datatable').on('click', '.update-info', function() {
            ...
            $.ajax({
                url: `<?php echo e(url('')); ?>/admin/partners-van/get-info/${bizId}`,
                success: (result) => {
    ...
    $(document).ready(function() {
        ...
        var url = "<?php echo e(custom_secure_url('admin/partners-van/report/edit-info')); ?>";
        var onDraw = function() {};
        var options = [{
    ...
    function setForm(response) {
        let res = `
        <form id="update-van-info-form" role="update-van-info-us-form" action="<?php echo e(url('admin/partners-van/edit-info/submit')); ?>" data-DataTables="datatable" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="account_number" class="form-control" value="${response.account_number}" required />
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="">IFSC <span class="requiredstar">*</span></label>
                            <input type="text" name="ifsc" class="form-control" value="${response.ifsc}" required />
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="">Beneficiary Name <span class="requiredstar">*</span></label>
                            <input type="text" name="beneficiary_name" class="form-control" value="${response.beneficiary_name}" required />
                        </div>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xettle-main\resources\views/admin/partners_van_edit_info.blade.php ENDPATH**/ ?>