...
<div aria-hidden="true" aria-labelledby="exampleModalLabel" class="modal fade" id="addIntegrationModal" role="dialog" tabindex="-1">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form id="orderForm" role="add-integration-form" action="<?php echo e(url('admin/integration/add-integration')); ?>" data-DataTables="datatable" method="POST">
                    <?php echo csrf_field(); ?>
...
<script>
    $(document).ready(function() {
        var url = "<?php echo e(custom_secure_url('admin/fetch')); ?>/Integration/0";
        var onDraw = function() {};
        var options = [ {
            "orderable": false,
            "searchable": false,
...
$.ajax({
    url:"<?php echo e(url('admin/integration/getIntegrationdata/')); ?>/"+id,
    type:"get",
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xettle-main\resources\views/admin/integration.blade.php ENDPATH**/ ?>