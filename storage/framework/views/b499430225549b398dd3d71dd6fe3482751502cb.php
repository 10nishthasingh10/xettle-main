...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var url = "<?php echo e(custom_secure_url('admin/get')); ?>/dmtTransaction/0";
        var onDraw = function() { 
        };
        var options = [
            {
...
{
    $.ajax({
        url:"<?php echo e(custom_secure_url('admin/reports/dmt')); ?>",
        type:'POST',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xettle-main\resources\views/admin/reports/dmtTransactionReport.blade.php ENDPATH**/ ?>