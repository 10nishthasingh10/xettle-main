    ...
    <div aria-hidden="true" aria-labelledby="exampleModalLabel" class="modal fade" id="addMessageModal" role="dialog" tabindex="-1">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form id="orderForm" role="add-message-form" action="<?php echo e(url('admin/offer/add-offer')); ?>" data-DataTables="datatable" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6 mb-1">
                                ...
                                <input type="date" id="fp-date-time" class="form-control" value="<?php echo e(date('Y-m-d')); ?>" min="<?php echo e(date('Y-m-d')); ?>" placeholder="YYYY-MM-DD HH:MM" name="expired_at">
                            </div>
...
<!-- <script src="<?php echo e(asset('summernote/summernote-ext-emoji.js')); ?>"></script> -->
...
//   $(document).ready(function() {
//     document.emojiSource = '<?php echo e(asset("summernote/pngs")); ?>/';
//       $('#editor').summernote({
...
<script>
    $(document).ready(function() {
        ...
        var url = "<?php echo e(custom_secure_url('admin/fetch')); ?>/offer_list/0";
        var onDraw = function() {};
        var options = [ {
                "data": "title"
            },
    ...
    $('#datatable').on('click','.edit-offer',function(){
        ...
        $.ajax({
            url:"<?php echo e(url('admin/offer/getOffer/')); ?>/"+id,
            type:"get",
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xettle-main\resources\views/admin/offers/offer.blade.php ENDPATH**/ ?>