...
<script>
    $(document).ready(function() {
        ...
        var url = "<?php echo e(custom_secure_url('user/fetch')); ?>/rechargeElectricity/0";
        var onDraw = function() {};
        var options = [{
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xettle-main\resources\views/user/recharge/electricity.blade.php ENDPATH**/ ?>