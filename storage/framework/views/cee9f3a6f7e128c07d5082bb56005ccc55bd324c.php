<?php $__env->startSection('title', 'Insurance Agents'); ?>
                                ...
                                <table class="table table-bordered table-striped table-hover" id="datatable"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Agent ID</th>
                                            <th>Agent Name </th>
                                            <th>Agent Mobile / Agent Email</th>
                                            <th>Agent PAN</th>
                                            <th>Status</th>
                                            <th>Created</th>
                                        </tr>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var url = "<?php echo e(custom_secure_url('admin/fetch')); ?>/insuranceAgent/0";
            var onDraw = function() {};
            var options = [{
                    "data": "user",
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xettle-main\resources\views/admin/insurance/insuranceAgent.blade.php ENDPATH**/ ?>