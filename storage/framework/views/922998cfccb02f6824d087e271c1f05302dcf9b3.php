                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" name="scheme_id_relation" id="scheme_id_relation">
                                                    ...
                                                    <?php $__currentLoopData = $schemes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($val->id); ?>"><?php echo e($val->scheme_name); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                        </div>
    ...
    <div aria-hidden="true" aria-labelledby="exampleModalLabel" class="modal fade" id="assignSchemeModal" role="dialog" tabindex="-1">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form role="assign-scheme-form" action="<?php echo e(url('admin/custom-billing/assign-scheme')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="user_token" name="user_token">
                                        ...
                                        <option value="<?php echo e(encrypt($row->id)); ?>"><?php echo e($row->name); ?> - <?php echo e($row->email); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="scheme_id" id="scheme_id">
                                        <option value="">--Select--</option>
                                        <?php $__currentLoopData = $schemes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e(encrypt($row->id)); ?>"><?php echo e($row->scheme_name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
...
<script src="<?php echo e(asset('admin-js/custom-billing.js?v=1.0.0')); ?>"></script>
...
<script src="<?php echo e(asset('admin-js/custom-billing-support.js?v=1.0.0')); ?>"></script>

<?php $__env->stopSection(); ?>

<?php endif; ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xettle-main\resources\views/admin/dynamic_billing.blade.php ENDPATH**/ ?>