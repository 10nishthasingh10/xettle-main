...
<script type="text/javascript">
    $(document).ready(function() {
        var url = "<?php echo e(secure_url('admin/fetch-reports/upi')); ?>";
        var onDraw = function() {};
        var options = [{
                "orderable": false,
                "searchable": false,
    ...
    function getRecords(from, to) {
        ...
        $.ajax({
            url: "<?php echo e(secure_url('admin/reports/upi')); ?>",
            type: 'POST',
            data: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pgpaysecureco/public_html/resources/views/admin/reports/upiTransactionReport.blade.php ENDPATH**/ ?>