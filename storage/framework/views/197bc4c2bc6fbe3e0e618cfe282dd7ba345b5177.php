...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var url = "<?php echo e(secure_url('admin/fetch-reports/payout')); ?>";
        var onDraw = function() {};
        var options = [{
    ...
    function getRecords(from, to) {
        ...
        $.ajax({
            url: "<?php echo e(secure_url('admin/reports/payout')); ?>",
            type: 'POST',
            data: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pgpaysecureco/public_html/resources/views/admin/reports/payout_report.blade.php ENDPATH**/ ?>