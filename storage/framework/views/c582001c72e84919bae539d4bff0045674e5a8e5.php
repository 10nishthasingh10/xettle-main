...
<script>
    ...
    $(document).ready(function() {
        var url = "<?php echo e(secure_url('admin/fetch')); ?>/roles/0";
        var onDraw = function() {};
        var options = [
            {
                "data": "name"
...
<script type="text/javascript">
    ...
    function changeStatus(id,action)
    {
        ...
        {
            $.ajax({
                url:"<?php echo e(secure_url('admin/roles/changeStatus')); ?>",
                type:'POST',
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pgpaysecureco/public_html/resources/views/admin/roles.blade.php ENDPATH**/ ?>