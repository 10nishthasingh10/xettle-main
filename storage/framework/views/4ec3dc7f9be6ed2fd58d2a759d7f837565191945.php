...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#datatable').on('click', '.update-info', function() {
            ...
            $.ajax({
                url: `<?php echo e(url('')); ?>/admin/smart-collect-van/get-info/${bizId}`,
                success: (result) => {
    ...
    $(document).ready(function() {
        ...
        var url = "<?php echo e(custom_secure_url('admin/smart-collect-van/report/edit-info')); ?>";
        var onDraw = function() {};
        var options = [{
    ...
    function setForm(response) {
        let res = `
        <form id="update-van-info-form" role="update-van-info-us-form" action="<?php echo e(url('admin/smart-collect-van/edit-info/submit')); ?>" data-DataTables="datatable" method="POST">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xettle-main\resources\views/admin/smart_collect_van_edit_info.blade.php ENDPATH**/ ?>