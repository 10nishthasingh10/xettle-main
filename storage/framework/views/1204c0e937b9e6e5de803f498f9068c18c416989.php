<?php $__env->startSection('title','VAN Callbacks Dashboard'); ?>
...
<script id="details-template" type="text/x-handlebars-template">
    <table class="expandtable">
        <tr>
            ...
            <td><b>Remitter Account :</b> {{remitter_account}}</td>
            <td><b>Remitter Name :</b> {{remitter_name}}</td>
		...
		<tr>
            ...
            <td><b>Amount Credited: {{is_trn_credited}}</td>
        </tr>
    </table>
</script>
<script>
...
<script type="text/javascript">
    $(document).ready(function() {
        var url = "<?php echo e(custom_secure_url('admin/fetch')); ?>/van-callbacks/0";
        var onDraw = function() {};
        var options = [{
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xettle-main\resources\views/admin/reports/van_callback.blade.php ENDPATH**/ ?>