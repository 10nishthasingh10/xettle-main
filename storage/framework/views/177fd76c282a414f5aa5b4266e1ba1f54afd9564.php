                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="user_id">
                                        ...
                                        <option value="<?php echo e($user->id); ?>" <?php if(isset($_GET['user_id']) && $_GET['user_id'] == $user->id): ?> selected  <?php endif; ?>><?php echo e($user->userName); ?></option>
...
<div aria-hidden="true" aria-labelledby="exampleModalLabel" class="modal fade" id="resellerCommissionModal" role="dialog" tabindex="-1">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="commissionForm" role="reseller-commission-form" action="<?php echo e(url('admin/reseller/reseller-commission')); ?>" data-DataTables="datatable" method="POST">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="reseller_id" id="reseller_id" value="<?php echo e($reseller_id); ?>">
...
<script>
    $(document).ready(function() {
        var url = "<?php echo e(custom_secure_url('admin/reseller/user-details/' . $reseller_id)); ?>";
        var onDraw = function() {};
        var options = [ {
            "orderable": false,
            "searchable": false,
...
<script type="text/javascript">
    ...
    $('#commissionForm').submit(function(event) {
        ...
        var url = "<?php echo e(url('admin/reseller/reseller-commission')); ?>";
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xettle-main\resources\views/admin//userDetails.blade.php ENDPATH**/ ?>