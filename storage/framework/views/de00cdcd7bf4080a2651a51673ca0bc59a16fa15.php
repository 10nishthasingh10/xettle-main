...
$(document).ready(function () {
    $('.js-example-basic-multiple').select2();
        var url = "<?php echo e(secure_url('aeps/fetch')); ?>/aepsTransaction/0";
        var onDraw = function() {
        };
        var options = [
            {
...
<?php echo $__env->make('layouts.user.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pgpaysecureco/public_html/resources/views/user/aeps/aepstransactions.blade.php ENDPATH**/ ?>