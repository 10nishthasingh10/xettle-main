...
<script type="text/javascript">
    $(document).ready(function() {
        var url = "<?php echo e(custom_secure_url('reseller/fetch-reports/upi')); ?>";
        var onDraw = function() {};
        var options = [{
                "orderable": false,
                "searchable": false,
    ...
    function getRecords(from, to) {
        ...
        $.ajax({
            url: "<?php echo e(custom_secure_url('reseller/reports/upi')); ?>",
            type: 'POST',
            data: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xettle-main\resources\views/reseller/upireports.blade.php ENDPATH**/ ?>