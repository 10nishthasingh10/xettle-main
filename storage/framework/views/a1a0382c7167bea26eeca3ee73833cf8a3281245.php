<div class="onboarding-modal modal fade animated" id="kt_modal_settelement_logs" tabindex="-1" aria-hidden="true">
									...
									<div class="modal-dialog ">
										...
										role="add-settlement" action="<?php echo e(url('admin/createSettlement')); ?>">
											<?php echo csrf_field(); ?>
												...
												<div class="modal-body py-10 px-lg-17">
                                                    ...
                                                    <select name="integration_id" class="form-control"  id="integration_id"
                                                            ...
                                                            data-placeholder="Select a Service..." class="form-select form-select-solid">
																...
																<?php $__currentLoopData = $integration; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $integration): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option
                                                                value="<?php echo e($integration->integration_id); ?>"><?php echo e($integration->name); ?></option>
									...
									<!--end::Modal dialog-->
								</div><?php /**PATH /home/pgpaysecureco/public_html/resources/views/user/payout/modals/settlementlogs.blade.php ENDPATH**/ ?>