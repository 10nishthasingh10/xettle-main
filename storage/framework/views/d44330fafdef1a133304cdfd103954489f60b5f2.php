   ...
   // getAepsRecords(from, to);
    ...
    function getPayoutRecords(from, to) {
        ...
        if (!isAjax) {
            ...
            $.ajax({
                url: "<?php echo e(custom_secure_url('admin/allreports/payout')); ?>",
                type: 'POST',
                data: {
    ...
    function getUPIRecords(from, to) {
        $.ajax({
            url: "<?php echo e(custom_secure_url('admin/allreports/upi')); ?>",
            type: 'POST',
            data: {
                _token: $('meta[name="csrf-token"]').attr('content'),
                from: from,
    ...
    function getVanRecords(from, to) {
        $.ajax({
            url: "<?php echo e(custom_secure_url('admin/allreports/van')); ?>",
            type: 'POST',
            data: {
                _token: $('meta[name="csrf-token"]').attr('content'),
                from: from,
    ...
    function getAepsRecords(from, to) {
            ...
            $.ajax({
                url: "<?php echo e(custom_secure_url('admin/allreports/aeps')); ?>",
                type: 'POST',
                data: {
                    _token: $('meta[name="csrf-token"]').attr('content'),
                    from: from,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xettle-main\resources\views/admin//reports/reports.blade.php ENDPATH**/ ?>