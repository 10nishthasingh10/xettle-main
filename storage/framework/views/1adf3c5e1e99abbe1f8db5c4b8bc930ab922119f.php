...
<?php echo $__env->make('user.upi.add_merchants', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script id="details-template" type="text/x-handlebars-template">
    ...
    <table class="expandtable">
        <tr>
            <td><b>City :</b></td><td>{{city}}</td><td><b>Pin Code :</b></td><td>{{pin_code}}</td><td><b>Sub Merchant Id :</b></td><td>{{sub_merchant_id}}</td>
        </tr>
		<tr>
            <td><b>Merchant Txn :</b></td>
            <td> {{merchant_txn_ref_id}}</td>
            <td>MCC :</td>
            <td>{{mcc}}</td>
            <td>Request ID :</td>
            <td>{{request_id}}</td>
...
<script type="text/javascript">
    $(document).ready(function() {
        var url = "<?php echo e(custom_secure_url('upi/fetch')); ?>/merchants/0";
        var onDraw = function() {};
        var options = [{
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xettle-main\resources\views/user/upi/merchant.blade.php ENDPATH**/ ?>