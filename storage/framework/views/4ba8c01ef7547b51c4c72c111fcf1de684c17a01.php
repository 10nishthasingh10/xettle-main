...
<meta name="user-token" content="<?php echo e(encrypt($userData->id)); ?>">
                    ...
                    <div class="ecommerce-customer-sub-info">
                        <div class="row ecc-sub-info-row">
                            ...
                            <div class="col-6 sub-info-value">
                                <?php if($userData->transaction_amount > 0): ?>
                                ₹<?php echo e(number_format($userData->transaction_amount,2)); ?>
                        ...
                        <div class="row ecc-sub-info-row">
                            ...
                            <div class="col-6 sub-info-value">
                                <?php if($userData->locked_amount > 0): ?>
                                ₹<?php echo e(number_format($userData->locked_amount,2)); ?>
                    ...
                    <div class="os-tabs-w">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="tab_overview">
                                <form role="update-profile" action="<?php echo e(custom_secure_url('admin/accounts/profile-update')); ?>" method="post">
                                    <?php echo csrf_field(); ?>
                                    <div class="row">
                                        <input type="hidden" name="user_id" value="<?php echo e(encrypt($userData->id)); ?>" />
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for=""> Name</label><input class="form-control" placeholder="Enter Name" name="name" value="<?php echo e($userData->name); ?>"  type="text">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="">Mobile *</label><input class="form-control" placeholder="Phone number" value="<?php echo e($userData->mobile); ?>" name="mobile" type="number">
                                            </div>
                                        </div>
                                ...
                                <form role="change-password" action="<?php echo e(custom_secure_url('admin/accounts/profile-change-password')); ?>" method="post">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="user_id" value="<?php echo e(encrypt($userData->id)); ?>" />
                                    <div class="row">
                                        <div class="col-sm-6">
                            ...
                            <div class="tab-pane" id="tab_sales">
                                <form role="update-business-profile" action="<?php echo e(url('admin/accounts/business-profile-update')); ?>" method="post">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="user_id" value="<?php echo e(encrypt($userData->id)); ?>" />
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <?php else: ?>
                                                    value="<?php echo e($userData->name); ?>" <?php endif; ?> type="text">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <?php else: ?>
                                                    value="<?php echo e($userData->mobile); ?>"
                                                    <?php endif; ?>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="reseller" class="form-control" data-control="select2" data-hide-search="true" data-placeholder="Select a Reseller..." class="form-select form-select-solid" >
                                                        ...
                                                        <?php $__currentLoopData = $data['resellers']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resellerdata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($resellerdata->id); ?>" <?php if(isset($data['userData']) &&  $data['userData']->reseller==$resellerdata->id): ?> selected <?php endif; ?>
                                                            ><?php echo e($resellerdata->name); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                            </div>
                                    ...
                                    <fieldset class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="hidden" name="update_by_user_id" value="<?php echo e(encrypt($userData->id)); ?>" />
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <?php else: ?>
                                                    value="<?php echo e($userData->pan_number); ?>"
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        ...
                                                        <?php else: ?>
                                                        value="<?php echo e($userData->pan_owner_name); ?>"
                                                        <?php endif; ?>
                                                        name="pan_owner_name"
                                                        type="text">
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <?php else: ?>
                                                    value="<?php echo e($userData->billing_label); ?>"
                                                    <?php endif; ?> type="text">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" name="address" ><?php if(isset($data['business_info'])): ?><?php echo e($data['business_info']->address); ?><?php endif; ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <?php else: ?>
                                                    value="<?php echo e($userData->pincode); ?>"
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        ...
                                                        <?php else: ?>
                                                        value="<?php echo e($userData->city); ?>"
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        ...
                                                        <?php else: ?>
                                                        value="<?php echo e($userData->gstin); ?>"
                                    ...
                                    <!--                    <option value="<?php echo e($account_manager->id); ?>"-->
                            ...
                            <div class="tab-pane " id="tab_bank">
                                ...
                                <?php else: ?>
                                <form role="update-bankDetails" action="<?php echo e(url('admin/accounts/update-bank-details')); ?>" method="post">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="user_id" value="<?php echo e(encrypt($userData->id)); ?>" />
                                    <div class="row">
                                        <div class="col-sm-6">
                            ...
                            <!--            API Overview-->
                                        <!--<?php if(CommonHelper::isServiceActive($userData->id,PAYOUT_SERVICE_ID) || CommonHelper::isServiceActive($userData->id,AEPS_SERVICE_ID) || CommonHelper::isServiceActive($userData->id,UPI_SERVICE_ID)): ?>-->
                            ...
                            <!--            </button>-->
                            <!--            <?php endif; ?>-->
                            <!--            <?php if((isset($user_config->is_sdk_enable) && $user_config->is_sdk_enable == '1') && CommonHelper::isServiceActive($userData->id, MATM_SERVICE_ID)): ?>-->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xettle-main\resources\views/admin//user_profile.blade.php ENDPATH**/ ?>