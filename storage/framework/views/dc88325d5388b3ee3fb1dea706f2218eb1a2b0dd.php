...
<div class="content-w">
    ...
    <script>
        ...
        $(document).ready(function() {
            var url = "<?php echo e(secure_url('admin/fetch')); ?>/orders/0";
            var onDraw = function() {};
            var options = [{
    ...
    <script type="text/javascript">
        ...
        function getContactId(id) {
            $id = id.value;
            $('#contactId').html('');
            $.get("<?php echo e(secure_url('admin/getContactByUserId')); ?>/" + $id, function(data, status) {
                if (data.status) {
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pgpaysecureco/public_html/resources/views/admin//reports/orders.blade.php ENDPATH**/ ?>