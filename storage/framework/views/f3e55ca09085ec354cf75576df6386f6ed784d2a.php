<?php $__env->startSection('title','PAN Dashboard'); ?>
                            ...
                            <div class="row mb-xl-2 mb-xxl-3">
                                ...
                                <div class="col-sm-6">
                                    <a class="element-box el-tablo centered trend-in-corner bold-label text-success" href="#">
                                        ...
                                        <?php echo e(empty(@$totalAmount[1]->totalCommissionCount) ? 0 : $totalAmount[1]->totalCommissionCount); ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var url = "<?php echo e(custom_secure_url('admin/get')); ?>/panCard/0";
        var onDraw = function() { 
        };
        var options = [
            {
...
{
    $.ajax({
        url:"<?php echo e(custom_secure_url('admin/reports/panCard')); ?>",
        type:'POST',
        ...
        success:function(response)
        {
            ...
            if (data[0].totalAmount != null) {
                    $('#totalSuccessTxn').html(`${data[0].totalCount} | ₹${data[0].totalAmount.toFixed(2)}`);
            }
            else {
            ...
            //    var totalAmount= parseFloat(data[1].totalCommissionAmount).toFixed(2);
                    $('#totalCommissionSuccessTxn').html(`${data[1].totCount}`);
            }
            else {
                $('#totalCommissionSuccessTxn').html(`${data[1].totCount}`);
            }
...
function showMerchant(user_id) {
    ...
    $.post("<?php echo e(url('admin/recharge/merchantList')); ?>",
        {
            user_id: user_id,
            from: from,
            to: to,
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xettle-main\resources\views/admin/reports/panTransactionReport.blade.php ENDPATH**/ ?>