...
<script>
    $(document).ready(function() {
        ...
        var url = "<?php echo e(secure_url('user/fetch')); ?>/exceldownload/<?php echo e(Auth::user()->id); ?>";
        var onDraw = function() {};
        var options = [ {
                "data": "file_name"
            },
...
<script type="text/javascript">
    ...
    function deleteFile(id)
    {
        ...
        {
            $.ajax({
                url:"<?php echo e(secure_url('user/removeExportFile/')); ?>"+"/"+id,
                type:"POST",
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pgpaysecureco/public_html/resources/views/user//download/list.blade.php ENDPATH**/ ?>