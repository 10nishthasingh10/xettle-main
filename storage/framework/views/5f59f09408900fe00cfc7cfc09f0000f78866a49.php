    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form id="verify-bank-form" role="verify-bank-form" action="<?php echo e(secure_url('admin/users-bank/verify-bank-account')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
?>
    <input type="hidden" id="bankUrl" value="<?php echo e(secure_url('admin/users-bank/report/bank-info/' . $user_id)); ?>">
...
<script>
    $(document).ready(function() {
        ...
        var url = "<?php echo e(secure_url('admin/fetch/upiInvoice/'.$user_id)); ?>";
        var onDraw = function() {};
        var options = [{
                "data": "invoice_id"
            },
        ...
        var url = "<?php echo e(secure_url('admin/get/lean_mark_txn/' . $user_id)); ?>";
        var onDraw = function() {};
        var options = [{
                "orderable": false,
                "searchable": false,
    ...
    function apiServiceUpdate(id) {
        $.ajax({
            url: `<?php echo e(secure_url('admin/api-service-activate')); ?>/${id}`,
            type: 'GET',
            success: function(res) {
    ...
    function statusUpdate(id) {
        $.ajax({
            url: "<?php echo e(secure_url('admin/serviceActivate')); ?>/" + id,
            type: 'GET',
            success: function(res) {
                $("#datatable").DataTable().ajax.reload();
            }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pgpaysecureco/public_html/resources/views/admin//reports/user_profile.blade.php ENDPATH**/ ?>