...
<input type="hidden" id="dashboardBalances" value="<?php echo e(custom_secure_url('reseller/dashboard/balances')); ?>">
<input type="hidden" id="dashboardUsersAmount" value="<?php echo e(custom_secure_url('reseller/fetch-reports/dashboard-users-amount')); ?>">
...
<script src="<?php echo e(asset('admin-js/reseller.js?v=1.0.3')); ?>"></script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xettle-main\resources\views/reseller/dashboard.blade.php ENDPATH**/ ?>