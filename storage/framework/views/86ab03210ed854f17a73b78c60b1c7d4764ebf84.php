    ...
    <div class="content-box">
        <div class="element-wrapper">
            <div class="element-box">
                ...
                <form id="rv-txn-form" role="rv-txn-us-form" action="<?php echo e(url('admin/dispute-transactions/upi-stack/submit')); ?>" data-DataTables="datatable" method="POST">
                ...
                <div class="row">
                    <div class="col-md-12 d-none" id="utr-response-data">
                        ...
                        <form id="rv-txn-form-final" role="rv-txn-us-form-final" action="<?php echo e(url('admin/dispute-transactions/upi-stack/final-submit')); ?>" data-DataTables="datatable" method="POST">
                            <fieldset class="form-group">
                                <?php echo csrf_field(); ?>
                                <div class="col-md-12">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var url = "<?php echo e(custom_secure_url('admin/dispute-transactions/report/upi-stack')); ?>";
        var onDraw = function() {};
        var options = [{
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xettle-main\resources\views/admin/disputed_upi_stack_txns.blade.php ENDPATH**/ ?>