<?php $__env->startSection('title', 'PAN Card Transactions'); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="row">
                                        <input type="hidden" name="queryString" id="queryString"
                                            value="<?php echo e(@$_GET['order_ref_id']); ?>" />
                                        <div class="col-md-12">
                                            <div class="form-group">
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var url = "<?php echo e(custom_secure_url('admin/fetch')); ?>/panTxn/0";
            var onDraw = function() {};
            var options = [{
                    "data": "user",
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xettle-main\resources\views/admin/pan/panCardTxn.blade.php ENDPATH**/ ?>