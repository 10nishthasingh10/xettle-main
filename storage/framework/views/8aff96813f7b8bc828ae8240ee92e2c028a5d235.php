...
<script>
    ...
    $(document).on('click', '#resendotp', function() {
        ...
        $.ajax({
            url: "<?php echo e(custom_secure_url('resendotp/')); ?>/" + userId,
            method: 'POST',
            async: false,
            data: {
                '_token': $token
...
<?php echo $__env->make('layouts.loginapp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xettle-main\resources\views/auth/login.blade.php ENDPATH**/ ?>