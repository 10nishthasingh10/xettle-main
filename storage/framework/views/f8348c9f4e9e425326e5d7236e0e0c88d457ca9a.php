                            ...
                            <div class="col-md-1">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="modal">
                                        ...
                                        <option value="<?php echo e($modal->modal); ?>"><?php echo e($modal->modal); ?></option>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <option value="">-- Select Method --</option>
                                        <?php $__currentLoopData = $method; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($method->method); ?>"><?php echo e($method->method); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        var url = "<?php echo e(custom_secure_url('admin/api-logs')); ?>";
        // var onDraw = function() {};
        var options = [{
                "orderable": false,
                "searchable": false,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xettle-main\resources\views/admin/reports/api_logs.blade.php ENDPATH**/ ?>