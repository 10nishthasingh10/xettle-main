...
<script>
    $(document).ready(function() {
        var url = "<?php echo e(custom_secure_url('admin/fetch')); ?>/Services/0";
        var onDraw = function() {};
        var options = [ {
            "orderable": false,
            "searchable": false,
...
$('#datatable').on('click', 'label.serviceActivation', function () {
    ...
    $.ajax({
        url: "<?php echo e(route('services.statusActions', ['id' => ':id'])); ?>".replace(':id', id),
        type: 'POST',
        data: {
            isActive: isActive,
            _token: csrf
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xettle-main\resources\views/admin/service.blade.php ENDPATH**/ ?>