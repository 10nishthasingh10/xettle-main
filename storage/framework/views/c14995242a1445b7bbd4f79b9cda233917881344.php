...
<div aria-hidden="true" aria-labelledby="exampleModalLabel" class="modal fade" id="approveBatchOrderModal" role="dialog" tabindex="-1">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="orderForm" role="approve-request-form" action="<?php echo e(url('admin/roles/add')); ?>" data-DataTables="datatable" method="POST">
                <?php echo csrf_field(); ?>
...
<script>
    ...
    $(document).ready(function() {
        var url = "<?php echo e(custom_secure_url('admin/fetch')); ?>/roles/0";
        var onDraw = function() {};
        var options = [
            {
                "data": "name"
...
<script type="text/javascript">
    ...
    function changeStatus(id,action)
    {
        ...
        {
            $.ajax({
                url:"<?php echo e(custom_secure_url('admin/roles/changeStatus')); ?>",
                type:'POST',
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xettle-main\resources\views/admin/roles.blade.php ENDPATH**/ ?>