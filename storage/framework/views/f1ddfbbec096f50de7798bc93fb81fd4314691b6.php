                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control service_id select2" name="userId" required>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                <label for="">Select Pipe <span class="requiredstar">*</span></label>
                                    <select class="form-control service_id select2" name="integration_id" required>
                                        <option value="">--Select--</option>
                                        ...
                                        <option value="<?php echo e($pipes->pipeName); ?>"><?php echo e($pipes->pipeName); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
...
<script>
    $(document).ready(function() {
        var url = "<?php echo e(custom_secure_url('admin/fetch')); ?>/IntegrationValue/0";
        var onDraw = function() {};
        var options = [ {
            "orderable": false,
            "searchable": false,
        ...
        var options = {
            ...
            ajax: {
                ...
                data: function(d) {
                    ...
                    // d.users = $('#searchForm').find('[name="users"]').val();
...
$('#datatable').on('click', 'label.serviceActivation', function () {
    ...
    $.ajax({
        url: "<?php echo e(route('integration.updateServiceActivation', ['id' => ':id'])); ?>".replace(':id', id),
        type: 'POST',
        data: {
            isActive: isActive,
            _token: csrf
...
<?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xettle-main\resources\views/admin/integration_value.blade.php ENDPATH**/ ?>