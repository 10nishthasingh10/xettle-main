...
<div style="padding: 20px 30px 0; border-top: 1px solid rgba(0,0,0,0.05);">
    ...
    <div style="text-align: center;">
        ...
        <div style="color: #636363; font-size: 14px; margin-bottom: 30px">
            Hi <?php echo e($data->name); ?>, We are delighted to have you with us
        </div>
    </div>
    ...
    <div style="border-radius: 10px; background-color: #F4F4F4; margin: 20px 0px 20px; padding: 20px 0; position: relative; overflow: auto;">
        ...
        <div style="margin: 10px 0 ;text-align: center; width: 100%; height: 196px;">
            <img src="<?php echo e(custom_secure_url('')); ?>/public/img/welcome.png" style="height: 100%;" alt="welcome logo" />
        </div>
...
<?php echo $__env->make('emails.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xettle-main\resources\views/emails/signup_welcome.blade.php ENDPATH**/ ?>