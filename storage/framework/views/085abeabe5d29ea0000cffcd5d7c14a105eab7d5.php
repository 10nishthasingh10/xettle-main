...
<script type="text/javascript">
    function businessCategory(id) {
        ...
        $.get("<?php echo e(secure_url('getbusiness_sub_category')); ?>/" + $id, function(data, status) {
            if (data.status) {
    ...
    // Api Key for
    $(document).ready(function() {
        var url = "<?php echo e(secure_url('user/fetch')); ?>/ipWhiteLists/0";
        var onDraw = function() {};
        var options = [{
                data: 'ip',
            },
        ...
        var url = "<?php echo e(secure_url('user/fetch')); ?>/webHookLists/0";
        var options = [{
                data: 'webhook_url'
            },
            {
    ...
    function webServiceUpdate(id) {
        $.ajax({
            url: `<?php echo e(secure_url('admin/web-service-activate')); ?>/${id}`,
            type: 'GET',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pgpaysecureco/public_html/resources/views/admin//user_profile.blade.php ENDPATH**/ ?>