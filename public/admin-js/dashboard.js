...
function handleFinancialOverviewCards(start, end, type) {
  ...
  getCardRecords("admin/data/payout/processed", dateData);
  getCardRecords("admin/data/payout/processing", dateData);
  getCardRecords("admin/data/payout/failed", dateData);

  getCardRecords("admin/data/aeps/success", dateData);
  getCardRecords("admin/data/aeps/pending", dateData);
  getCardRecords("admin/data/aeps/failed", dateData);
  ...
  getCardRecords("admin/data/dmt/processed", dateData);
  getCardRecords("admin/data/dmt/failed", dateData);
  getCardRecords("admin/data/dmt/processing", dateData);

  getCardRecords("admin/data/matm/processed", dateData);
  getCardRecords("admin/data/matm/failed", dateData);
  getCardRecords("admin/data/matm/pending", dateData);

  getCardRecords("admin/data/pancard/success", dateData);
  getCardRecords("admin/data/pancard/failed", dateData);
  getCardRecords("admin/data/pancard/pending", dateData);
}
